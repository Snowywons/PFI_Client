...
function CustomFunctionToCallAfterPreloadImage(event) {
    editNews(event);
}

function assignImageDownloaderEvents() {
    $('.imageDownloader').each(function() {
        ...
        if (this.getAttribute('listener') !== 'true') {
            ...
            $(this).append('<img id="' +
                            id +
                            '_UploadedImage" class="UploadedImage thumbnail" src="' +
                            defaultImage +
                            '">');
            ...
            //-------------------------------------------------------------------------------------------------
            if (this.getAttribute('canbeedited') == 'true')
        ...
        if (len !== 0) {
            ...
            if ((ext !== "png") &&
                ...
                fReader.onloadend = () => {
                    ...
                    CustomFunctionToCallAfterPreloadImage(event);
                };
            }
        }
        else {
